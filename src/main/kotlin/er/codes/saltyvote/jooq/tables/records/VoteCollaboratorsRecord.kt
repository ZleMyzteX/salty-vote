 ...
 */
@Suppress("warnings")
open class VoteCollaboratorsRecord() : UpdatableRecordImpl<VoteCollaboratorsRecord>(VoteCollaborators.VOTE_COLLABORATORS) {
    ...
    /**
     * Create a detached, initialised VoteCollaboratorsRecord
     */
     ...
     * Create a detached, initialised VoteCollaboratorsRecord
     */
    constructor(value: er.codes.saltyvote.jooq.tables.pojos.VoteCollaborators?): this() {
        if (value != null) {
            this.id = value.id
